...
estimated_num_awards_p1 = predict(awardsglm2,program1,type="response")
estimated_num_awards_p2 = predict(awardsglm2,program2,type="response")
estimated_num_awards_p3 = predict(awardsglm2,program3,type="response")
```

The expected number of awards for programs 1, 2, and 3 are `r round(estimated_num_awards_p1[[1]], 4)`, `r round(estimated_num_awards_p2[[1]],4)`, and `r round(estimated_num_awards_p3[[1]],4)` respectively. 
